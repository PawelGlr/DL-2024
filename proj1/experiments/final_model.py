...
if __name__ == '__main__':
    ...
    class ResNetClassifier(pl.LightningModule):
        def __init__(self):
            ...
            self.resnet.fc = torch.nn.Linear(2048, 10)
    ...
    results = []
    train_dataloader, valid_dataloader, test_dataloader = next(get_cv_data_loaders(train_transforms=[transforms.RandomHorizontalFlip(0.25), transforms.RandomVerticalFlip(0.25)]))
