...
if __name__ == '__main__':
    ...
    run_name = "resnet18/test_aug_rotate_max"
    ...
    results = []
    for train_dataloader, valid_dataloader, test_dataloader in get_cv_data_loaders(train_transforms=[transforms.RandomRotation(degrees=(0, 180))]):
